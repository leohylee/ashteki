...
export class InnerAddDraftDeck extends React.Component {
    constructor(props) {
        super();
                    ...
                    <Row>
                        <Col lg={6} className='full-height'>
                            <div className='lobby-card'>
                                ...
                                <DeckEditor mode='AddDraft' onDeckSave={this.onAddDeck} />
                            </div>
                        </Col>
                        <Col lg={6}>
                            <div className='lobby-card'>
...
InnerAddDraftDeck.displayName = 'InnerAddDraftDeck';
InnerAddDraftDeck.propTypes = {
    addDraftDeck: PropTypes.func,
...
const AddDraftDeck = connect(mapStateToProps, actions)(InnerAddDraftDeck);

export default AddDraftDeck;
